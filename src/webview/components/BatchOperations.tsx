...
const BatchOperations: React.FC<BatchOperationsProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "convert" | "analyze" | "thumbnail" | "metadata"
  >("convert");
  ...
  const simulateFileConversion = async (
    file: MediaFile,
    ...
    return {
      ...
      outputPath: file.path.replace(
        /\.[^.]+$/,
        `.${options.toFormat.toLowerCase()}`,
      ),
