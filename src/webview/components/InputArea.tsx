...
const InputArea: React.FC<InputAreaProps> = ({ 
  ...
  }, [showSuggestions, suggestions, selectedSuggestionIndex, isFocused, historyIndex, commandHistory]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (inputValue.trim()) {
      ...
      if (inputValue.startsWith('/')) {
        ...
        CommandHistoryManager.addToHistory(command, args.join(' ') || undefined);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Press Enter to send {attachedFiles.length > 0 && `(${attachedFiles.length} files attached)`}
        </div>
