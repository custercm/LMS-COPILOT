...
export function runStreamingComponentTests(): Promise<{passed: number, failed: number}> {
  let passed = 0;
  let failed = 0;
  ...
  try {
    ...
    console.log(`Streaming component tests: ${passed} passed, ${failed} failed`);
  ...
  return {
    validateProps: (props: StreamingIndicatorProps): boolean => {
      ...
      if (props.progress !== undefined &&
          (typeof props.progress !== 'number' || props.progress < 0 || props.progress > 100)) {
        return false;
      }
